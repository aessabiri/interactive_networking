...
export default function App() {
  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen bg-[#10121a] text-slate-100 flex flex-col font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        {/* Footer */}
        <footer className="border-t border-white/[0.04] bg-[#10121a]/80 backdrop-blur-md px-6 py-4 text-xs text-white/40 font-sans">
