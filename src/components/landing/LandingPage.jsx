  ...
  const categories = [
    {
      ...
      items: [
        ...
        { id: 'hardware', title: 'Hardware & RAID', desc: 'RAID 0/1/5/6/10 & redundant PSUs', icon: HardDrive, tag: 'Hardware' },
        { id: 'topology', title: 'Network Topologies', desc: 'Star, Mesh, Tree, Ring & Bus', icon: Share2, tag: 'Topologies' },
        { id: 'enterprise', title: 'Enterprise Infra', desc: 'HQ Data Center vs WAN map', icon: Building2, tag: 'Multi-Hop' },
        { id: 'dhcp', title: 'DHCP Protocol', desc: '4-step DORA & L3 Relay Agent', icon: Zap, tag: 'DHCP' },
        { id: 'dns', title: 'DNS Resolver', desc: 'Forward/Reverse & root lookup', icon: Globe, tag: 'DNS' },
        { id: 'ad', title: 'Active Directory', desc: 'Forest, Domain Controllers & OUs', icon: ShieldCheck, tag: 'Identity' },
        { id: 'lan', title: 'LAN & VLAN Trunking', desc: 'VLAN 802.1Q, CAM Table & ARP', icon: Layers, tag: 'L2 Switch' },
        { id: 'mail', title: 'Mail Server', desc: 'SMTP relaying & IMAP delivery', icon: Mail, tag: 'Mail' },
        { id: 'firewall', title: 'Firewall & IPsec VPN', desc: 'Stateful SPI, NAT & TLS 1.3', icon: ShieldAlert, tag: 'NGFW' },
        { id: 'routing', title: 'Routing Protocols', desc: 'OSPF vs RIP link-state multi-path', icon: Share2, tag: 'L3 Routing' },
      ]
    },
    {
      id: 'learn_test',
      ...
      items: [
        ...
        { id: 'labs', title: 'Lab Scenarios', desc: 'Troubleshooting challenges', icon: Trophy, tag: 'Challenges' },
        { id: 'dts', title: 'DTS Cockpit SOC', desc: 'Managed SOC & SOAR playbooks', icon: ShieldCheck, tag: 'DTS SOC' },
        { id: 'configure', title: 'Cisco CLI Generator', desc: 'Cisco IOS script exporter', icon: Settings, tag: 'Cisco IOS' },
      ]
    },
    {
      id: 'sandbox',
      ...
      items: [
        { id: 'sandbox', title: 'Freeform Topology Sandbox', desc: 'Drag-and-drop builder & terminal', icon: Network, tag: 'Sandbox' },
      ]
    }
  ];
          ...
          <section key={cat.id} className="space-y-3.5">
            ...
            <div className="flex items-center justify-between border-b border-white/[0.04] pb-2 px-1">
              <div className="flex items-center gap-2.5">
                ...
                <h2 className="text-sm font-bold text-white/90 tracking-tight">{cat.title}</h2>
                <span className="text-[11px] font-mono text-white/40">({cat.items.length})</span>
              </div>
